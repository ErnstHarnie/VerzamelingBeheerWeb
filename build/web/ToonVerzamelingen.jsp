...
<link rel="stylesheet" href="css/styles.css"/>
    ...
    <body>
        ...
        <table class="table table-bordered table-hover">
            ...
            <div style="font-size:20px"><tr><th>Type</th><th>Naam</th><th>Beschrijving</th><th>Categorie</th><th>In bezit</th></tr></div>
    ...
    %>
    <tr>
        <th><%= types.get(verzameling.getTypeId() - 1).getNaam() %></th><th><%= verzameling.getNaam() %></th><th><%= verzameling.getBeschrijving()%></th><th><%= categorieën.get(verzameling.getCategoryId() - 1 ).getNaam() %></th><th><%= VerzamelingService.ConvertJaNee(verzameling.isInBezit()) %></th>
    </tr>
    <%}%>
        </table>
